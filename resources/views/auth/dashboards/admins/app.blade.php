...
<head>
  ...
  <body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="page-header">
        <div class="header-wrapper row m-0">
          ...
          <div class="nav-right col-10 col-sm-6 pull-right right-header p-0 ms-auto">
            <ul class="nav-menus">
            <li><marquee> Hi, <span class="text-white bg-danger">{{auth()->user()->name}}</span></marquee></li>
              <li>
                ...
                <ul class="profile-dropdown onhover-show-div">
                  <li><a href="{{ route('logout') }}"
                                    onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"><i data-feather="log-out"> </i><span>Log out</span></a></li>
          ...
          <script class="result-template" type="text/x-handlebars-template">
            ...
            <div class="ProfileCard-realName">dfgfdg</div>
            </div>
            </div>
          </script>
            ...
            <nav class="sidebar-main">
              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{route('admin.dashboard')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g>
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{route('admin.websites')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g>
                      ...
                      </svg><span>All Link</span></a></li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{route('admin.user')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g>
                      ...
                      </svg><span>Create User</span></a></li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{route('admin.alluser')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g>
                      ...
                      </svg><span>All User</span></a></li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{route('admin.informations')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g>
                      ...
                      </svg><span>Information</span></a></li>
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12 footer-copyright text-center">
                <p class="mb-0">Copyright 2022 © Genius  </p>
              </div>
            </div>
          </div>
        </footer>
        <audio id="audiotag1" src="{{asset('notfication.wav')}}" preload="auto" style="display: none"></audio>
      </div>
    </div>
    <!-- latest jquery-->
    ...
    <script>
        ...
        var pusher = new Pusher('0090e00a82a30c6666ea', {
            cluster: 'mt1'
        });
        ...
        channel.bind('my-event', function(data) {
            ...
            //  var msg = `df
            //     <div class="alert alert-success dark alert-dismissible fade show" role="alert"><i data-feather="clock"></i>
            //           <p>New Account Arrived</p>
      ...
      message:'HI, Admin New Account Arrived'
   },
   {
      type:'success',
      allow_dismiss:false,
