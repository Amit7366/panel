  ...
  <body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="page-body-wrapper">
            ...
            <nav class="sidebar-main">
              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{route('user.dashboard')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g> 
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{route('user.websites')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g> 
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{route('user.informations')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g> 
        ...
        <input id="userID" value="{{auth()->user()->id}}">
      </div>
    </div>
    <!-- latest jquery-->
    ...
    if(userId == test){
              ...
              message:'HI, User New Account Arrived'
           },
           {
              type:'success',
              allow_dismiss:false,
